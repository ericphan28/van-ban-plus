...
> **Liên kết**: [Nội dung chính](../noi-dung.md) | [Điều 9](../noi-dung.md)
>
> **Áp dụng vào VanBanPlus**: AI soạn thảo phải tuân thủ quy tắc viết hoa này khi tạo văn bản hành chính.
...
đ) Tên địa lý chỉ một vùng, miền, khu vực nhất định được cấu tạo bằng từ chỉ phương hướng kết hợp với từ chỉ phương hướng khác: Viết hoa chữ cái đầu của tất cả các âm tiết tạo thành tên gọi. Ví dụ: Tây Bắc, Đông Bắc, Bắc Bộ,...
...
b) Tên địa lý phiên âm không sang âm Hán - Việt: Viết hoa theo quy tắc viết hoa tên người nước ngoài quy định tại điểm b khoản 2 Mục II Phụ lục này. Ví dụ: Mát-xcơ-va, Men-bơn,...
...
b) Tên cơ quan, tổ chức nước ngoài viết tắt: Viết bằng chữ in hoa như nguyên ngữ. Ví dụ: WTO, UNDP, UNESCO, ASEAN,...

## V. VIẾT HOA CÁC TRƯỜNG HỢP KHÁC

1. Danh từ thuộc trường hợp đặc biệt: **Nhân dân**, **Nhà nước**.

2. Tên các huân chương, huy chương, các danh hiệu vinh dự: Viết hoa chữ cái đầu của các âm tiết tạo thành tên riêng và các từ chỉ thứ, hạng. Ví dụ: Huân chương Sao vàng, Nghệ sĩ Nhân dân, Anh hùng Lao động,...
...
4. Danh từ chung đã riêng hóa: Viết hoa chữ cái đầu trong trường hợp dùng trong nhân xưng, đứng độc lập và thể hiện sự trân trọng. Ví dụ: Bác, Người (chỉ Chủ tịch Hồ Chí Minh), Đảng (chỉ Đảng Cộng sản Việt Nam),…

5. Tên các ngày lễ, ngày kỷ niệm: Viết hoa chữ cái đầu của âm tiết tạo thành tên gọi. Ví dụ: ngày Quốc khánh 2-9, ngày Quốc tế Lao động 1-5, ngày Phụ nữ Việt Nam 20-10,...

6. Tên các loại văn bản: Viết hoa chữ cái đầu của tên loại văn bản và chữ cái đầu của âm tiết thứ nhất tạo thành tên gọi khi nói đến một văn bản cụ thể. Ví dụ: Bộ luật Hình sự, Luật Tổ chức Quốc hội,…

7. Viện dẫn phần, chương, mục, tiểu mục, điều, khoản, điểm của một văn bản cụ thể thì viết hoa chữ cái đầu. Ví dụ:
...
- a) Tên các năm âm lịch: Viết hoa chữ cái đầu tất cả các âm tiết. Ví dụ: Kỷ Tỵ, Tân Hợi, Mậu Tuất, Mậu Thân,...
- b) Tên các ngày tết: Viết hoa chữ cái đầu của âm tiết thứ nhất. Ví dụ: tết Nguyên đán, tết Đoan ngọ, tết Trung thu. Viết hoa chữ Tết khi thay cho tết Nguyên đán.
- c) Tên các ngày trong tuần và tháng: Viết hoa chữ cái đầu khi không dùng chữ số. Ví dụ: thứ Hai, thứ Tư, tháng Năm, tháng Tám,...

9. Tên các sự kiện lịch sử và triều đại: Viết hoa chữ cái đầu của các âm tiết tạo thành tên sự kiện. Ví dụ: Triều Lý, Triều Trần, Cách mạng tháng Tám,…

10. Tên các tác phẩm, sách báo, tạp chí: Viết hoa chữ cái đầu của âm tiết thứ nhất. Ví dụ: từ điển Bách khoa toàn thư, tạp chí Cộng sản,…
