...
>
> **Áp dụng vào VanBanPlus**: Tiêu chuẩn kỹ thuật cho phần mềm.
...
8. Cho phép ký số, kiểm tra, xác thực chữ ký số theo quy định của 
pháp luật.
...
- d) Lưu dữ liệu đặc tả của quá trình kiểm soát an ninh văn bản, hồ sơ, 
hệ thống.
...
| 7 | Tên cơ quan, tổ chức ban hành văn bản | OrganName | String | 200 |
...
| 13 | Nơi nhận | To |  |  |
| 13.1 | Mã định danh của cơ quan, tổ chức nhận văn bản | OrganId | String | 13 |
...
| 17 | Ý kiến phân phối, chỉ đạo, trạng thái xử lý văn bản | TraceHeaderList | LongText |  |
