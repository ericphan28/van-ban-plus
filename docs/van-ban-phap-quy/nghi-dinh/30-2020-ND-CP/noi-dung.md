...
> **Nguồn**: https://thuvienphapluat.vn/van-ban/Bo-may-hanh-chinh/Nghi-dinh-30-2020-ND-CP-cong-tac-van-thu-437498.aspx  
> **Hiệu lực**: Còn hiệu lực  
> 
> **Ghi chú**: Đánh dấu `[RELEVANT]` cho các điều áp dụng trực tiếp vào VanBanPlus.  
> Xem [Phụ lục I-VI](phu-luc/) để biết chi tiết thể thức, mẫu, bảng viết tắt.
...
### Điều 3. Giải thích từ ngữ `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Các định nghĩa dùng trong models, tooltips, help text. Đặc biệt khoản 3 (văn bản hành chính), khoản 10–12 (sao y, sao lục, trích sao), khoản 14–15 (hồ sơ, lập hồ sơ).
...
### Điều 7. Các loại văn bản hành chính `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Enum `DocumentType`, dropdown "Loại văn bản", AI soạn thảo phải biết đủ 29 loại.

### Điều 8. Thể thức văn bản `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Template soạn thảo, AI system prompt, validation thể thức.

### Điều 9. Kỹ thuật trình bày văn bản `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Xem [Phụ lục I](phu-luc/phu-luc-I.md), [Phụ lục II (viết hoa)](phu-luc/phu-luc-II.md), [Phụ lục III (viết tắt)](phu-luc/phu-luc-III.md).

### Mục 2. SOẠN THẢO VÀ KÝ BAN HÀNH VĂN BẢN HÀNH CHÍNH

### Điều 10. Soạn thảo văn bản `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Quy trình soạn thảo trong app (chọn loại VB → soạn nội dung → trình duyệt).
...
### Điều 13. Ký ban hành văn bản `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Quy tắc ký (KT., TL., TM., TUQ.) trong template.
...
### Điều 14. Trình tự quản lý văn bản đi `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Workflow quản lý văn bản đi trong app (cấp số → đăng ký → phát hành → lưu).

### Điều 15. Cấp số, thời gian ban hành văn bản `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Auto-increment số văn bản, format ký hiệu `Số/Loại-CQ`, reset đầu năm.
...
### Điều 18. Phát hành và theo dõi việc chuyển phát văn bản đi `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Trạng thái phát hành, thu hồi, đính chính văn bản trong app.

### Điều 19. Lưu văn bản đi `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Lưu trữ bản gốc điện tử, phân biệt bản gốc/bản chính trong database.
...
### Điều 25. Các hình thức bản sao `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Tính năng Sao y, Sao lục, Trích sao trong app.

### Điều 26. Giá trị pháp lý của bản sao `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Hiển thị trạng thái pháp lý của bản sao trong app.

### Điều 27. Thẩm quyền sao văn bản `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Phân quyền sao văn bản trong app.
...
> **Áp dụng vào VanBanPlus**: Tổ chức hồ sơ/thư mục trong phần mềm.
...
### Điều 33. Sử dụng con dấu, thiết bị lưu khóa bí mật `[RELEVANT]`
...
> **Áp dụng vào VanBanPlus**: Quy tắc đóng dấu trùm 1/3 chữ ký.
...
> **Ký ban hành**: TM. CHÍNH PHỦ — THỦ TƯỚNG — Nguyễn Xuân Phúc  
> **Nơi nhận**: Ban Bí thư TW Đảng; Thủ tướng, các Phó Thủ tướng CP; Các bộ, cơ quan ngang bộ, cơ quan thuộc CP; HĐND, UBND các tỉnh, TP trực thuộc TW; VP TW và các Ban của Đảng; VP Tổng Bí thư; VP Chủ tịch nước; HĐ Dân tộc và các UB của QH; VP Quốc hội; VKSND tối cao; TAND tối cao; Kiểm toán Nhà nước; và các cơ quan, tổ chức liên quan.
