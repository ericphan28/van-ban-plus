...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        // Auto-update: chỉ configure, KHÔNG check ngay — defer 10s sau khi MainWindow shown
        AppUpdateService.Initialize();
        
        // Auto-backup: defer sang background thread sau khi MainWindow shown
        // (tránh block UI thread với ZIP compression)
    }
